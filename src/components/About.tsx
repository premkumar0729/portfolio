            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl p-8 border-2 border-blue-200 dark:border-blue-800">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                  Hello! I'm Premkumar E
                </h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  A passionate B.E Computer Science Engineering student graduating in 2026,
                  with strong UI/UX design and frontend development skills. I combine
                  technical expertise with creative design thinking to build exceptional
                  digital experiences.
                </p>
              </div>
            </div>
