import { ExternalLink, Figma, Code, Sparkles, Box, X } from 'lucide-react';
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      gradient: 'from-cyan-600 to-teal-600',
        mediaBlocks: [
        {
          video: "/projects/glarix.in.mp4",
        },
        {
          image: "/projects/glarix.png",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      mediaBlocks: [
        {
          video: "/projects/portfolio1.mp4",
          image: "/projects/portfolio1.png",
        },
        {
          video: "/projects/portfolio2.mp4",
    ...
    {
      title: '3D Product Model – Tea Shop',
      tools: ['Blender', '3D Design'],
      icon: Box,
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tools.map((tool, i) => (
                    <span key={i} className="px-3 py-1 text-sm bg-white dark:bg-gray-700 rounded-full">
                      {tool}
                    </span>
                  ))}
                </div>
                ...
                {project.link && (
                  <a href={project.link} target="_blank" className="inline-flex items-center gap-2 text-blue-600 font-semibold">
          ...
          <div className="relative w-full max-w-4xl h-[90vh] bg-white dark:bg-gray-900 rounded-xl overflow-hidden">
            ...
            <div className="h-full overflow-y-auto">
              ...
              {activeProject.video && !activeProject.mediaBlocks && (
                <video src={activeProject.video} controls autoPlay className="w-full h-[60vh] object-contain bg-black" />
              )}
              ...
              <div className="p-6 space-y-12">
                ...
                {activeProject.mediaBlocks?.map((block, index) => (
                  <div key={index} className="space-y-6">
                    {block.video && (
                      <video src={block.video} controls className="w-full h-[60vh] object-contain bg-black rounded-xl" />
                    )}
                    {block.image && (
                      <img src={block.image} alt="Project mockup" className="w-full rounded-xl shadow-lg" />
                    )}
                  </div>
                ))}
              </div>
